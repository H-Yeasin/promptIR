...
All notable changes to the "promptir" extension will be documented in this file.

Check [Keep a Changelog](http://keepachangelog.com/) for recommendations on how to structure this file.

## [Unreleased]

- Added PromptIR Composer intent presets.
- Added Analyze Current Problems for VS Code diagnostics-focused prompt generation.
